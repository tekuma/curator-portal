CREATE TABLE artworks (uid CHAR(255) UNIQUE, title TEXT, description TEXT, artist_uid CHAR(255), date_of_addition DATETIME, date_of_creation DATETIME, thumbnail_url CHAR(255), origin CHAR(32), reverse_lookup CHAR(255), META TEXT)
