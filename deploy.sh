...
rsync -v --exclude=.git --exclude=node_modules --delete -z -a -e 'ssh -i serv/cert/sql-client-cert.pem' . scottclivingston@curator.tekuma.io:/home/scottclivingston/curator-portal
